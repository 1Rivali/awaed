...
const BOARD_WIDTH = 1000; // pixels
const BOARD_HEIGHT = 400; // pixels
const BOARD_ROWS = 9;

const ballRadius = 20; // pixels
const pegRadius = 15; // pixels
...
const DesktopPlinkoBalls: React.FC = () => {
      ...
      >
        {PlinkoSegments.map((segment, index) => (
          <Image
            ...
            width={[2, 3, 4, 5, 7].includes(index) ? "180px" : "100px"}
          />
        ))}
      </Box>
...
export default DesktopPlinkoBalls;
