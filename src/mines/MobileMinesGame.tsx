...
const MobileMinesGame: React.FC = () => {
  ...
  // Use a fixed card size for mobile.
  ...
  // The board is filled with one copy of each available PlinkoSegment,
  ...
  return (
    ...
    >
      ...
      >
        {/* Game Board */}
        <Grid templateColumns="repeat(3, 1fr)" gap={6} p="20px">
          {board.map((box) => (
      ...
      <Box
        ...
        zIndex={50}
      >
        <Image mb="3vh" width="15vh" src={awaedWritten} />
        <Image width="15vh" src={arzLogo} />
      </Box>
      ...
      <Box
        ...
        alignItems="center"
      >
        <Image w="40px" src={countIcon} mr="10px" />
        <Text
          as="span"
          fontSize="20px"
      ...
      <Box
        ...
        zIndex={200}
      >
        <Image src={statisticsButton} w="60px" h="60px" />
      </Box>
...
export default MobileMinesGame;
